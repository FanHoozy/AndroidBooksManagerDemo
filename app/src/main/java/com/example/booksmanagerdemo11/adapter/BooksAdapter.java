...
public class BooksAdapter extends RecyclerView.Adapter<BooksAdapter.ViewHolder> {
    ...
    private List<Borrows> bookList;

    // 因为网络请求之后，产生的数据需要设置进来
    public void setBookList(List<Borrows> bookList) {
        this.bookList = bookList;
        notifyDataSetChanged(); // 数据更新后，刷新页面
    }

    public BooksAdapter(List<Borrows> bookList) {
        this.bookList = bookList;
    }
    ...
    public BooksAdapter(int layoutResource, List<Borrows> bookList) {
        this.layoutResource = layoutResource;
        this.bookList = bookList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.bookItemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Borrows book = bookList.get(position);
                Toast.makeText(v.getContext(), "id:" + book.getBorrowsBookId() + "书名：" + book.getBorrowsBookName()
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final Borrows book = bookList.get(position);
        holder.tvClassification.setText(book.getBorrowsStuId());
        holder.tvTitle.setText(book.getBorrowsBookName());
        holder.tvAuthor.setText(book.getBorrowsTime());
    }
